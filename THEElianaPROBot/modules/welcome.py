...
import THEElianaPROBot.modules.sql.welcome_sql as sql
from THEElianaPROBot import (
    DEV_USERS,
    LOGGER,
    OWNER_ID,
    DRAGONS,
...
from THEElianaPROBot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from THEElianaPROBot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from THEElianaPROBot.modules.helper_funcs.msg_types import get_welcome_type
from THEElianaPROBot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from THEElianaPROBot.modules.log_channel import loggable
from THEElianaPROBot.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "Thanks for adding me! Join @TVB_Discussion for support.",
                    reply_to_message_id=reply,
                )
                continue

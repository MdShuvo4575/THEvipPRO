...
This file should be placed in your `THEElianaPROBot` folder, alongside the `__main__.py` file. 
...
```
from THEElianaPROBot.sample_config import Config
...
`from THEElianaPROBot import dispatcher`.
